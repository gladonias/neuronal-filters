	...
	Prop *_prop;
{
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 ProbAMPANMDA_EMS /home/gadonias/Dropbox/TSSG-WIT/NEURON/CCM/models_bNAC/models/L23_LBC_bNAC219_3/x86_64/ProbAMPANMDA_EMS.mod\n");
...
static int  state ( _p, _ppvar, _thread, _nt ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; {
...
static int  setRNG ( _p, _ppvar, _thread, _nt ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; {
...
double urand ( _p, _ppvar, _thread, _nt ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; {
   double _lurand;
...
double toggleVerbose ( _p, _ppvar, _thread, _nt ) double* _p; Datum* _ppvar; Datum* _thread; _NrnThread* _nt; {
